...
/**
 * extension of JButton which contains an additional listener per each click {@link DeleteModelButton#DeleteModelButton(FrameTab, BasicModel, DeleteAction, String)}
...
public class DeleteModelButton<T extends BasicModel> extends JButton {
    ...
    /**
     * Creates a listener which calls {@link DeleteAction<T>#apply(T)} per each button click and reloads the page
     * to update the page where delete is called
     *
